...
public class Room {
	...
	public static final int ROOM_TYPE_SUPERIOR1 = 2; // 더블 1개 싱글 1개/4명/엑스트라 가능 //401-10
	public static final int ROOM_TYPE_SUPERIOR2 = 3; // 더블 2개 /5명/엑스트라 가능 // 411-20
	public static final int ROOM_TYPE_DELUXE1 = 4; // 더블1개/2명/엑스트라 가능 // 301-10
	public static final int ROOM_TYPE_DELUXE2 = 5; // 퀸 1개/2명/엑스트라 불가 // 311-20
	public static final int ROOM_TYPE_EXECUTIVE1 = 6; // 퀸 1개 킹 1개/4명/엑스트라 가능 501-10
	public static final int ROOM_TYPE_EXECUTIVE2 = 7; // 더블 2개 퀸 1개/6명/엑스트라 가능 511-19
	...
	public boolean canUseExtraBed() {
    	switch (roomType) {
    	case ROOM_TYPE_STANDARD1: case ROOM_TYPE_DELUXE2: case ROOM_TYPE_SUITEROOM:
    		return false;
    	}
    	return true;
    }
